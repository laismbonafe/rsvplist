...
class RSVPSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, Request $request = NULL) {
    ...
    $form['rsvplist_types'] = [
      ...
      '#options' => $types,
      '#description' => t('On the soecified node types, an RSVP option will be available and can be enabled while that node is being edited.'),
    ];
    $form['array_filter'] = ['#type' => 'value', '#valie' => TRUE];
